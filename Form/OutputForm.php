...
class OutputForm extends Form {    
    ...
    public function __construct() {
        ...
        $this->setActionForm('Output.php');

        $this->setClass('output form-horizontal');
    ...
    public function init() {                
        ...
        $this->addElement(array(
            ...
            'optionals'=>array('onKeyPress'=>'onEnterOutput(event.keyCode,this)','placeholder'=>'Teclea o escanea producto para la salida'),
        ...
        $this->addElement(array(
            ...
            'optionals'=>array("onClick"=>"submit('output')")
