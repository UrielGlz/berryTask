...
class ReportForm extends Form
{
    ...
    public function getListDepositStatus()
    {

        $storeRepo = new DepositRepository();
    ...
    public function getStringFiltersForm($report)
    {
        ...
        switch ($report) {
            ...
            case 'deposits':
                ...
                $this->addElement(array('type' => 'select multiple', 'name' => 'status', 'label' => 'Status', 'multiOptions' => $this->getListDepositStatus(), 'required' => false, ));
