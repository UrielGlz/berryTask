<section class="content-header">
    ...
    <h1><i class='fa-fw fa fa-bar-chart'></i>
        <?php echo $_translator->_getTranslation('Reportes'); ?></small>
    </h1>
                ...
                switch ($login->getRole()) {
                    ...
                    case '1': ?>
                        ...
                        <a class="grid-item" href="?action=create&report=inventory&output=screen">
                            ...
                            <?php echo $_translator->_getTranslation('Inventario'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="store_request">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Pedidos de sucursales'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="time_clock">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Reloj checador'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="sales">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Ventas'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="special_orders">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Ordenes especiales'); ?>

                        </a>

                        <a class="grid-item" href="?action=create&report=inventory_template_pdf&output=pdf"
                            target="_pdf_para_inventario">

                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('PDF para inventarios'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="physical_inventory">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Inventario fisico'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="bakery_production">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Produccion panaderia'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="detailed_bakery_orders">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Pedidos panaderia detallado'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="sales_to_store">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Ventas a sucursal'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="sales_by_store">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Ventas netas por sucursal'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="review_payroll">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Revision de payroll'); ?>
                        ...
                        <a class="grid-item _report" data-reportname="invoices">
                            ...
                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Facturas'); ?>

                        </a>

                        <!--

                <a class="grid-item _report" data-reportname="deposits">

                    <i class="fa fa-signal"></i><br /><?php echo $_translator->_getTranslation('Depositos'); ?>

                </a>-->

                        <a class="grid-item _report" data-reportname="users_list">

                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Lista de usuarios'); ?>

                        </a>
                        <a class="grid-item _report" data-reportname="mermas">

                            <i class="fa fa-signal"></i><br />
                            <?php echo $_translator->_getTranslation('Mermas'); ?>
