<!-- Modal -->
<div id="modalAddInvoiceProduct" class='modal fade' data-backdrop="static" data-keyboard="false" role="dialog" style=" overflow: hidden;background: transparent">
    ...
    <div class="modal-content">
        <div class="modal-body"> 
            ...
            <div class="box-header with-border">
                ...
                <h4><i class='fa-fw fa fa-database'></i> <span id="title_modal_invoiceProduct"><?php echo $_translator->_getTranslation('Agregar producto o servicios');?></span></h4>
            </div>
                <?php 
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        <?php $formAddProduct->showElement('price');?>
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        <?php $element = $formAddProduct->getElement('description_details');?>
                        <div class="form-group"><?php echo $formAddProduct->createOnlyElement($element);?> </div>
                    </div>     
                </div>
    ...
    <script>
        $('#modalAddInvoiceProduct').on('shown.bs.modal', function (e) {
            $('#product').focus();
