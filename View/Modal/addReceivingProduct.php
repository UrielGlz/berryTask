<!-- Modal -->
<div id="modalAddReceivingProduct" class='modal fade' data-backdrop="static" data-keyboard="false" role="dialog" style=" overflow: hidden;background: transparent">
    ...
    <div class="modal-content">
        <div class="modal-body"> 
            ...
            <div class="box-header with-border">
                ...
                <h4><i class='fa-fw fa fa-database'></i> <span id="title_modal_receivingProduct"><?php echo $_translator->_getTranslation('Agregar producto');?></span></h4>
            </div>
                <?php 
                ...
                <div class="box-body">
                    ...
                    <?php 
                    $formAddProduct->showElement('idDetailTemp');
                    $formAddProduct->showElement('id_product');
                    $formAddProduct->showElement('added');?>
    ...
    <script>
        $('#modalAddReceivingProduct').on('shown.bs.modal', function (e) {
