  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-cube"></i> <span><?php echo $_translator->_getTranslation('Produccion') ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">            
            <li><a href="SpecialOrder.php?action=list-production"><i class="fa fa-fw fa-circle-o"></i> <?php echo $_translator->_getTranslation('OE - Plan de decorado')?></a></li>                         
            <li><a href='Baked.php?action=list'><i class="fa fa-fw fa-circle-o"></i> <?php echo $_translator->_getTranslation('OE - Plan de horneado')?></a></li>                       
            <li><a href='Baked.php?action=listr'><i class="fa fa-fw fa-circle-o"></i> <?php echo $_translator->_getTranslation('OE - Plan de Roscas')?></a></li>                       
          </ul>
        </li>            
